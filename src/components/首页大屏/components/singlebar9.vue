          ...
          <el-tab-pane>
            ...
            <el-collapse class="drawer_head" v-model="activeName" accordion style="fontSize: 18;">
              ...
              <el-collapse-item title="布局" name="6">
                ...
                <div class="block">
                  <span class="demonstration">圆环密集度</span>
        ...
        series: [
          {
            name: '',
            type: 'pictorialBar',
            symbolSize: this.dialogVisable ? ['50%', this.radius + 15] : ['50%', 12],
            symbolOffset: [0, 18],
            symbolRepeat: true,
            symbolMargin: -10,
            z: 11,
            ...
            name: '',
            type: 'pictorialBar',
            symbolSize: this.dialogVisable ? ['60%', 30] : ['60%', 6],
            symbolOffset: [0, 20],
            z: 10,
            itemStyle: {
              color: 'transparent',
          ...
          },
          {
            name: '',
            type: 'pictorialBar',
            symbolSize: this.dialogVisable ? ['70%', 35] : ['70%', 7],
            symbolOffset: [0, 22],
            z: 10,
            itemStyle: {
              color: 'transparent',
