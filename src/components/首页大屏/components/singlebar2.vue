          ...
          <el-tab-pane>
            ...
            <el-collapse class="drawer_head" v-model="activeName" accordion style="fontSize: 18;">
              ...
              <el-collapse-item title="布局" name="6">
                ...
                <div class="block">
                  <span class="demonstration">柱间距比例因子</span>
                  <el-slider v-model="radius" show-input>
                  </el-slider>
                </div>
                <div class="block">
                  <span class="demonstration">切角比例因子</span>
    ...
    drawChart() {
      ...
      const InclinedRoofColumn = this.$echarts.graphic.extendShape({
        ...
        buildPath: function (ctx, shape) {
          ...
          const c1 = [shape.x - (vm.dialogVisable ? vm.radius : 5), shape.y - vm.cut];
          const c2 = [xAxisPoint[0] - (vm.dialogVisable ? vm.radius : 5), xAxisPoint[1]];
            ...
            renderItem: (params, api) => {
              ...
              return {
                ...
                shape: {
                  ...
                  yValue: api.value(1),
                  x: location[0] + (vm.dialogVisable ? 40 : 5),
                  y: location[1],
                  xAxisPoint: [api.coord([api.value(0), 0])[0] + (vm.dialogVisable ? 40 : 5), api.coord([api.value(0), 0])[1]],
                },
                style: {
                  fill: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
                    {
