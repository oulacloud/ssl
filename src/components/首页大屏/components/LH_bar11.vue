          ...
          <el-tab-pane>
            ...
            <el-collapse class="drawer_head" v-model="activeName" accordion style="fontSize: 18;">
              ...
              <el-collapse-item title="数据标签" name="7">
                ...
                <div class="block">
                  <span class="demonstration">左图数据条颜色配置</span>
                ...
                <div class="block">
                  <span class="demonstration">右图数据条颜色配置</span>
      ...
      var option = {
        ...
        xAxis: [
          ...
          },
          {
            ...
            name: this.y2_unit,
            nameLocation: 'center',
            nameTextStyle: { align: 'top', color: this.y2LabelColor, lineHeight: 40, },
        ...
        },
        {
          ...
          data: this.x.map(function (value) {
            return {
              value: value,
              textStyle: {
                align: 'center'
