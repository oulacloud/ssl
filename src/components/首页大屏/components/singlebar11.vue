        ...
        <el-tabs type="border-card">
          <el-tab-pane>
            ...
            <el-collapse class="drawer_head" v-model="activeName" accordion style="fontSize: 18;">
              ...
              <el-collapse-item title="下侧x轴" name="3">
                ...
                <div class="block">
                  <el-input v-model="x_unit" placeholder="请输入单位" class="input" :disabled="!x_show">
                    <span slot="prepend">下x轴单位</span>
                  </el-input>
                </div>
              </el-collapse-item>
              <el-collapse-item title="上侧x轴" name="5">
              ...
              <el-collapse-item title="布局" name="6">
                ...
                <div class="block">
                  <span class="demonstration">圆角半径</span>
        ...
        xAxis: [
          {
            ...
            name: this.x_unit,
            nameLocation: 'end',
            nameTextStyle: { align: 'right', color: this.xLabelColor, verticalAlign: 'top', lineHeight: 50, },
            // x轴更换数据
          ...
          },
          {
            ...
            name: this.y2_unit,
            nameLocation: 'end',
            nameTextStyle: { align: 'right', color: this.y2LabelColor, verticalAlign: 'bottom', lineHeight: 50, },
            // x轴更换数据
            // 文本颜色为rgba(0,0,0,.6)  文字大小为 12
            axisLabel: {
