  ...
  methods: {
    ...
    dev5(x) {
      ...
      var option = {
        ...
        radar: {
          indicator: [
            { name: '2018年', min: min, max: max },
            { name: '2019年', min: min, max: max },
            { name: '2020年', min: min, max: max },
            { name: '2021年', min: min, max: max },
            { name: '2022年', min: min, max: max },
            { name: '2023年', min: min, max: max }
          ],
          // center: ['25%', '50%'],
          radius: '70%',
          alignTicks: false,
