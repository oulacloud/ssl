              ...
              <el-tab-pane>
                ...
                <el-collapse class="drawer_head" v-model="activeName" accordion style="fontSize: 18;">
                  ...
                  <el-collapse-item title="图标签" name="7">
                    ...
                    <!-- <div class="block">
                      <span class="demonstration">图例颜色DIY</span>
                      <el-input v-model="itemTc" placeholder="请选择字体颜色" class="input">
                        <span slot="prepend">顶部颜色</span>
                      </el-input>
                      <el-color-picker show-alpha v-model="itemTc" class="colorPicker">
                      </el-color-picker><br>
                    </div>
                    <div class="block">
                      <el-input v-model="itemBc" placeholder="请选择字体颜色" class="input">
                        <span slot="prepend">底部颜色</span>
                      </el-input>
                      <el-color-picker show-alpha v-model="itemBc" class="colorPicker">
                      </el-color-picker><br>
                    </div> -->
                  </el-collapse-item>
                </el-collapse>
