  ...
  <div class="LVbody">
    ...
    <section class="mainbox">
      ...
      <div class="column">
        ...
        <div v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)" class="panel bar1">
          <h2>2018-2023年摇号情况</h2>
          <div class="chart"></div>
          <div class="panel-footer"></div>
        </div>
        <div v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)" class="panel bar2">
          <h2>2018-2023年摇号情况</h2>
          <div class="chart"></div>
          <div class="panel-footer"></div>
        </div>
        <div v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)" class="panel bar3">
          <h2>2018-2023年摇号情况</h2>
          <div class="chart"></div>
          <div class="panel-footer"></div>
        </div>
        <div v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)" class="panel bar4">
          <h2>2018-2023年摇号情况</h2>
          <div class="chart"></div>
          <div class="panel-footer"></div>
        </div>
        <div v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)" class="panel bar5">
          <h2>2018-2023年摇号情况</h2>
          <div class="chart"></div>
          <div class="panel-footer"></div>
        </div>
        <div v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)" class="panel bar6">
          <h2>2018-2023年摇号情况</h2>
          <div class="chart"></div>
          <div class="panel-footer"></div>
        </div>
        <div v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)" class="panel bar7">
          <h2>2018-2023年摇号情况</h2>
          <div class="chart"></div>
          <div class="panel-footer"></div>
        </div>
        <div v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)" class="panel bar8">
          <h2>2018-2023年摇号情况</h2>
          <div class="chart"></div>
          <div class="panel-footer"></div>
        </div>
        <div v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)" class="panel bar9">
          <h2>2018-2023年摇号情况</h2>
          <div class="chart"></div>
          <div class="panel-footer"></div>
        </div>
        <div v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)" class="panel bar10">
          <h2>2018-2023年摇号情况</h2>
          <div class="chart"></div>
          <div class="panel-footer"></div>
        </div>
...
export default {
  ...
  methods: {
    ...
    // 获取飞行接口数据
    async getData1() {
      await axios.get("http://sslapi.nadibao.cn/api/HzYaoHaoData/GetCompanyCross", '阿里')
        .then(res => {
          // console.log(res);
          for (var i = 0; i < res.data.data.length; i++) {
      ...
      await axios.get("http://sslapi.nadibao.cn/api/HzYaoHaoData/Get_MID_TALENT_BUYER_TYPE_NUM_ALLYEAR")
        .then(res => {
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            this.zk[i] = data[i].TYPE_ZHUANKE_NUM
            this.js[i] = data[i].TYPE_JISHU_NUM
            this.sums[i] = this.zk[i] + this.bk[i] + this.ss[i] + this.bs[i] + this.js[i] + this.qt[i]
            this.sum3t.push([this.zk[i], this.bk[i], this.ss[i], this.bs[i], this.js[i], this.qt[i]])
          }
          this.sum3.push(this.zk, this.bk, this.ss, this.bs, this.js, this.qt);
          [...this.sum3].map((x, i) => {
            var ss = 0
            var li = [];
            [...x].map((re) => {
          ...
          // console.log(this.zzl)
        })
    },
    // 左1柱状
    dev010() {
      // 柱状图10
      var myChart = echarts.init(document.querySelector(".bar10 .chart"));
      // 2. 指定配置项和数据
      var option = {
        ...
        },
        {
          ...
          itemStyle: {
            color: {
              ...
              colorStops: [{
                offset: 0,
                color: 'rgba(221, 234, 79, 1)' // 0% 处的颜色
              }, {
                offset: 1,
                color: 'rgba(221, 234, 79, 1)' // 100% 处的颜色
              }],
              globalCoord: false // 缺省为 false
            } //底色
          },
        ...
        },
        {
          ...
          itemStyle: {
            color: {
              ...
              colorStops: [{
                offset: 0,
                color: 'rgba(36, 255, 182, 1)' // 0% 处的颜色
              }, {
                offset: 1,
                color: 'rgba(36, 255, 182, 1)' // 100% 处的颜色
              }],
              globalCoord: false // 缺省为 false
            } //底色
          },
          ...
          itemStyle: {
            color: {
              ...
              colorStops: [{
                ...
                offset: 1,
                color: '#f7f3c6' // 100% 处的颜色
              }],
              globalCoord: false // 缺省为 false
            } //底色
          },
          symbolPosition: 'start',
          data: [...this.renci].map(x => 0),
        },
        {
          // 线
          name: "line",
        ...
        },
        {
          ...
          itemStyle: {
            color: {
              ...
              colorStops: [{
                offset: 0,
                color: 'rgba(115, 115, 115, 1)' // 0% 处的颜色
              }, {
                offset: 1,
                color: 'rgba(115, 115, 115, 1)' // 100% 处的颜色
              }],
              globalCoord: false // 缺省为 false
            } //底色
          },
          data: [...this.renci].map(x => (1.5 * x).toFixed(2)),
        },]
      }
      this.loading = true
      // 3. 把配置项给实例对象
        ...
        series: [
          {
            ...
            itemStyle: {
              ...
              borderColor: new echarts.graphic.LinearGradient(
                ...
                [{
                  offset: 0,
                  color: 'rgba(4, 245, 173, 1)'
                },
                {
                  offset: 1,
                  color: 'rgba(4, 245, 173, .5)'
                },
                ]
              ),
              borderType: 'solid',
          ...
          },
          {
            ...
            itemStyle: {
              ...
              borderColor: new echarts.graphic.LinearGradient(
                ...
                [{
                  offset: 0,
                  color: 'rgba(4, 129, 245, 1)'
                },
                {
                  offset: 1,
                  color: 'rgba(4, 129, 245, .5)'
                },
                ]
              ),
              borderType: 'solid',
        ...
        series: [{
          ...
          itemStyle: {
            color: {
              ...
              colorStops: [{
                offset: 0,
                color: 'rgba(13, 249, 163, 1)' // 0% 处的颜色
              }, {
                offset: 1,
                color: 'rgba(181, 209, 254, 0.42)' // 100% 处的颜色
              }],
              globalCoord: false // 缺省为 false
            } //底色
          },
        ...
        series: [
          ...
          },
          {
            ...
            label: {
              ...
              formatter:
                function (param) {
                  return vm.renci[param.dataIndex];
                },
            },
            tooltip: { show: false },
            symbolRepeat: "fixed",
          ...
          // 图标展示
          {
            ...
            itemStyle: {
              color: new echarts.graphic.LinearGradient(
                ...
                [{
                  offset: 0,
                  color: "rgba(100,37,117,0.3)"
                },
                {
                  offset: 1,
                  color: "rgba(0,133,20,0.3)"
                },
                ]
              ),
              borderWidth: 5,
    ...
    dev02() {
      ...
      var option = {
        ...
        series: [{
          ...
          data: [...this.renci].map((x) => ({ value: x, symbolPosition: 'end' }))
        }, {
          name: '',
          type: 'pictorialBar',
          symbolSize: ['36%', 10],
    ...
    dev01() {
      ...
      // 注册三个面图形
      this.$echarts.graphic.registerShape('InclinedRoofColumn', InclinedRoofColumn);
      // 2. 指定配置项和数据
      var option = {
        backgroundColor: '#fff', //背景色
        tooltip: {
        ...
        series: [
          {
            ...
            renderItem: (params, api) => {
              ...
              // const colors = ['rgb(207,27,125)', 'rgb(204,29,127)', '#456', '#789', '#788'];
              return {
                ...
                style: {
                  fill: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
                    {
                      offset: 0,
                      color: this.bgc[params.dataIndex],
                    },
                    {
                      offset: 1,
                      color: 'rgba(2,213,228,0.2)',
                    },
                  ]),
                },
              };
          ...
          },
          {
            ...
            renderItem: (params, api) => {
              const location = api.coord([api.value(0), api.value(1)]);
              // location = [location[0]+13,location[1]];
              ...
              return {
                ...
                shape: {
                  api,
                  xValue: api.coord([api.value(0), 0])[0] + 1,
                  yValue: api.value(1),
                  x: location[0] + 20,
                  y: location[1],
                  xAxisPoint: [api.coord([api.value(0), 0])[0] + 20, api.coord([api.value(0), 0])[1]],
                },
                style: {
                  fill: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
                    {
    ...
    dev6() {
      ...
      const luffyData = [...this.le3].map((res, index) => ({ name: res, value: this.sump[index], zlevel: index, animationEasing: 'elasticInOut' }))
    ...
    // 右3
    dev7() {
      var myChart = echarts.init(document.querySelector(".cbar2 .chart"));
      // mock 数据
      const dataArr = {
        xdata: this.name,
    ...
    // 中2
    dev11() {
      var myChart = echarts.init(document.querySelector(".bbar3 .chart"));
      var option = {
        backgroundColor: 'rgba(255,255,255,1)',
        tooltip: {
          trigger: 'axis',
