        ...
        <el-tabs type="border-card">
          <el-tab-pane>
            ...
            <el-collapse class="drawer_head" v-model="activeName" accordion style="fontSize: 18;">
              ...
              <el-collapse-item title="右侧数据标签" name="5">
              ...
              <el-collapse-item title="数据标签" name="7">
                <el-switch v-model="itemLabel_show" inactive-text="外框数据是否显示" class="switch">
                </el-switch>
                <div class="block">
                ...
                <div class="block">
                  <span class="demonstration">数据条颜色配置</span>
                  <el-input v-model="kColor" placeholder="请选择外框颜色" class="input">
                    <span slot="prepend">外框颜色</span>
                  </el-input>
                  <el-color-picker show-alpha v-model="kColor" class="colorPicker">
                  </el-color-picker><br>
                </div>
                <div class="block">
    ...
    drawChart() {
      ...
      var option = {
        ...
        xAxis: [
          {
            ...
            name: this.x_unit,
            nameLocation: 'center',
            nameTextStyle: { align: 'bottom', color: this.xLabelColor, verticalAlign: 'bottom', lineHeight: 30, },
            // x轴更换数据
            position: 'top',
        ...
        },
        {
          name: this.y2_unit,
          nameLocation: 'center',
          nameTextStyle: { align: 'left', color: this.y2LabelColor, verticalAlign: 'left', lineHeight: 0, },
