      ...
      await axios.get("http://sslapi.nadibao.cn/api/HzYaoHaoData/Get_PEOPLE_PROVINCE_CITY_NUM_ALLYEAR")
        .then(res => {
          ...
          for (var i = 0; i < this.resData.length; i++) {
            ...
            // 老杭州男性
            else if (this.resData[i].NAME == 'CITY_LOCAL_FAMILY') {
              var list = {}
            ...
            // 老杭州女性
            else if (this.resData[i].NAME == 'CITY_LOCAL_PERSONAL') {
              var list = {}
            ...
            // 省内新杭州男性
            else if (this.resData[i].NAME == 'OUTCITY_INPROVINCE_FAMILY') {
              var list = {}
            ...
            // 省内新杭州女性
            else if (this.resData[i].NAME == 'OUTCITY_INPROVINCE_PERSONAL') {
              var list = {}
            ...
            // 省外新杭州男性
            else if (this.resData[i].NAME == 'OUTCITY_OUTPROVINCE_FAMILY') {
              var list = {}
            ...
            // 省外新杭州女性
            else if (this.resData[i].NAME == 'OUTCITY_OUTPROVINCE_PERSONAL') {
              var list = {}
