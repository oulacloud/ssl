<template>
  <div class="LVbody">
    ...
    <section class="mainbox">
      <!-- 中 -->
      <div class="column">
        <div class="panel sbar">
          <h2 style="fontSize:24px">2018-2022年度摇号累计新增人数
            <a href="javacript:;"></a>
            <a href="javascript:;"></a>
          </h2>
...
export default {
  data() {
    return {
      x: ['2018年度', '2019年度', '2020年度', '2021年度', '2022年度'],
      fz: [0, 131147, 333739, 505906, 682054, 734133],
      y: [131147, 202592, 172167, 176148, 52079],
      yearData: [],
      backgroundColor: "",
      fontSize: 20,
      color: "",
  ...
  methods: {
    ...
    // 中2
    dev11() {
      var myChart = echarts.init(document.querySelector(".sbar .chart"));
      var option = {
        tooltip: {
          trigger: 'axis',
          ...
          formatter: function (params) {
            ...
            return tar.name + '<br/>' + tar.seriesName + ' : ' + tar.value + '(人次)';
          }
        },
        toolbox: {
          show: true,
          ...
          feature: {
            myTool: {
              ...
              onclick: function () {
                //生成全屏显示的图表
                if (setFullScreenToolBox(option, '摇号新增人数')) {
                  chartScreen
                } else { return false }
              }
            },
