      ...
      await axios.get("http://sslapi.nadibao.cn/api/HzYaoHaoData/Get_PEOPLE_PROVINCE_CITY_NUM_ALLYEAR")
        .then(res => {
          ...
          for (var i = 0; i < res.length; i++) {
            ...
            // 老杭州男性
            else if (res[i].NAME == 'CITY_LOCAL_MALE') {
              var list = {}
              this.nums[0] = res[i]
            ...
            // 老杭州女性
            else if (res[i].NAME == 'CITY_LOCAL_FEMALE') {
              var list = {}
              this.nums[1] = res[i]
            ...
            // 省内新杭州男性
            else if (res[i].NAME == 'OUTCITY_INPROVINCE_MALE') {
              var list = {}
              this.nums[2] = res[i]
            ...
            // 省内新杭州女性
            else if (res[i].NAME == 'OUTCITY_INPROVINCE_FEMALE') {
              var list = {}
              this.nums[3] = res[i]
            ...
            // 省外新杭州男性
            else if (res[i].NAME == 'OUTCITY_OUTPROVINCE_MALE') {
              var list = {}
              this.nums[4] = res[i]
            ...
            // 省外新杭州女性
            else if (res[i].NAME == 'OUTCITY_OUTPROVINCE_FEMALE') {
              var list = {}
              this.nums[5] = res[i]
