        ...
        <el-tabs type="border-card">
          <el-tab-pane>
            ...
            <el-collapse class="drawer_head" v-model="activeName" accordion style="fontSize: 18;">
              ...
              <el-collapse-item title="上y轴" name="4">
                ...
                <div class="block">
                  <el-input v-model="y_unit" placeholder="请输入单位" class="input" :disabled="!y_show">
                    <span slot="prepend">上y轴单位</span>
                  </el-input>
                </div>
              </el-collapse-item>
              <el-collapse-item title="下y轴" name="5">
              ...
              <el-collapse-item title="数据标签" name="7">
                ...
                <div class="block">
                  <span class="demonstration">下图数据条颜色配置</span>
    ...
    drawChart() {
      ...
      var option = {
        ...
        grid: [
          {
            show: false,
            left: this.dialogVisable ? `${this.border_dis / 2 + '%'}` : '8%',
        ...
        },
        {
          ...
          name: this.x_unit,
          nameLocation: 'start',
          nameTextStyle: { align: 'center', color: this.xLabelColor, verticalAlign: 'center', lineHeight: 0, },
          // x轴更换数据
          // position: 'top',
        ...
        },
        {
          name: this.y2_unit,
          nameLocation: 'start',
          nameTextStyle: { align: 'center', color: this.y2LabelColor, verticalAlign: 'center', lineHeight: 0, },
        ...
        series: [
          ...
          },
          {
            ...
            label: {
              formatter: function (params) {
                const a = params;
                var a1 = `${a.value > 0 ? a.value : -a.value}`;
                return a1;
              },
              show: this.dialogVisable ? this.itemLabel_show : false,
              position: 'bottom',
