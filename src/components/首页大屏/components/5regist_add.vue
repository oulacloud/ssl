      ...
      await axios.get("http://sslapi.nadibao.cn/api/HzYaoHaoData/Get_MID_YEAR_ADD_NUM_ONEYEAR_AND_ALLYEAAR")
        .then(res => {
          ...
          for (var i = 0; i < this.resData.length; i++) {
            ...
            this.nd[i] = (this.resData[i].NUM_ONEYEAR / 10000).toFixed(2)
            this.lj[i] = (this.resData[i].NUM_ALLYEAR / 10000).toFixed(2)
            this.cz[i] = (this.resData[i].NUM_ONE_CUT_ALL).toFixed(0)
