      ...
      await axios.get("http://sslapi.nadibao.cn/api/HzYaoHaoData/Get_PEOPLE_PROVINCE_CITY_NUM_ALLYEAR")
        .then(res => {
          ...
          for (var i = 0; i < this.resData.length; i++) {
            if (this.resData[i].NAME === 'CITY_LOCAL' || this.resData[i].NAME === 'OUTCITY_INPROVINCE' || this.resData[i].NAME === 'OUTCITY_OUTPROVINCE') {
              var v2 = parseFloat((this.resData[i].NUM / 10000).toFixed(2))
